                ...
                <div class="container">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-9" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#announcementModal">
                                +
                            </button>
                                ...
                                <div class="container" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <div class="swiper init-swiper">
                                        <div class="swiper-wrapper">
                                            <c:set var="dayBefore" value="" scope="page"/>
                                            <c:forEach items="${AnnouncementDAO.getAnnouncementsByClubId(clubID)}" var="announcement">
                                                <c:if test="${!dayBefore.equals(announcement.getDate())}">
                                                    <h3>${announcement.getDate()}</h3>
                                                    <c:set var="dayBefore" value="${announcement.getDate()}" scope="page"/>
                                                </c:if>
                                                <div class="swiper-slide">
                                                    <div class="testimonial-wrap">
                                                        <div class="testimonial-item">
                                                            <img src="${pageContext.request.contextPath}/userPages/assets/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                                                            <h3>${AccountDAO.getAccountByID(announcement.getCreatedBy()).getFullname()}</h3>
                                                            <h4>${announcement.getTime()}</h4>
                                                            <p>
                                                                <span>${announcement.getContent()}</span>
                                                            </p>
                                                        </div>
                                                    </div>
