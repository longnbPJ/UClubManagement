...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/userPages/assets/css/custom.css?v=1.0.12" rel="stylesheet">
    </head>
    <body>
        ...
        <main class="main">
            ...
            <jsp:include page="../components/pageTitle.jsp">
                ...
                <jsp:param name="imgURL" value = "${pageContext.request.contextPath}/userPages/assets/img/page-title-bg.jpg"/>
            </jsp:include>
            ...
            <section id="alt-services" class="alt-services section account-section">
                    ...
                    <div class="row justify-content-center align-items-center gy-4">
                        ...
                        <div class="col-lg-8 d-flex flex-column justify-content-center">
                            ...
                            <div class="icon-box d-flex position-relative">
                                ...
                                <div>
                                    <h4><a href="${pageContext.request.contextPath}/User?page=clubs&id=${user.getAccountID()}" class="stretched-link">My clubs</a></h4>
                            ...
                            <div class="icon-box d-flex position-relative">
                                ...
                                <div>
                                    <h4><a href="${pageContext.request.contextPath}/User?page=events&id=${user.getAccountID()}" class="stretched-link">My events</a></h4>
                            ...
                            <div class="icon-box d-flex position-relative">
                                ...
                                <div>
                                    <h4><a href="${pageContext.request.contextPath}/User?page=sendMessage&id=${user.getAccountID()}" class="stretched-link"></a>Send Message</h4>
                                    <p>Send message to a person by email</p>
                                </div>
                            </div><!-- End Icon Box -->
                            ...
                            <div class="icon-box d-flex position-relative">
                                ...
                                <div>
                                    <h4><a href="${pageContext.request.contextPath}/User?page=info&id=${user.getAccountID()}" class="stretched-link"></a>My information</h4>
                            ...
                            <div class="icon-box d-flex position-relative">
                                ...
                                <div class="logout-container">
                                    <h4><a href="Logout" class="stretched-link">Log out</a></h4>
                                    <p></p>
                                </div>
                            </div>
