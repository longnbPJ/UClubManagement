<%-- 
    Document   : events
    Created on : Mar 11, 2025, 12:19:54 AM
    Author     : admin
--%>
        ...
        <main class="main">
            ...
            <section id="blog-posts" class="blog-posts section eventsReview">
                ...
                <div class="container">
                    ...
                    <div class="row gy-4 justify-content-center search-section mb-4">

                    </div>

                    <div class="gy-4 projects isotope-layout events-container" data-default-filter="*" data-layout="masonry" data-sort="original-order">

                        <div class="row gy-3 isotope-container mt-3">

                            <c:forEach items="${EventDAO.getEvents()}" var="event">
                                <c:if test="${!event.getStatus().equals('Cancel')}">
